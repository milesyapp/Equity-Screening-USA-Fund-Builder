    ...
    return {
        ...
        "methodology": {
            ...
            "limitations": [
                ...
                "break.",
                "Weighting regime change (code 2026-06-12; effective in the "
                "forward log at the FIRST WEEKLY REBALANCE AFTER that date — "
                "weights are frozen between weeklies, so rows up to and "
                "including the 2026-06-12-priced week used score weights for "
                "all arms): the QUBO arms moved from score weights to weights "
                "derived from the continuous relaxation of the QUBO objective "
                "(same lambdas and covariance; greedy remains score-weighted "
                "as the baseline). Selections are unchanged. Measured at the "
                "change date: weight "
